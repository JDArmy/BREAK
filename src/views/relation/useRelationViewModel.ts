...
export const useRelationViewModel = () => {
  ...
  const lineColorVarMap: Record<keyof typeof relationLineColors, string> = {
    ...
    riskPrerequisite: "--break-line-cause-risk",
    riskCoOccurrence: "--break-line-related-term",
    riskEscalation: "--break-line-direct-risk",
    riskVariant: "--break-line-sub",
    avoidancePrerequisite: "--break-line-cause-risk",
    avoidanceComplement: "--break-line-avoidance",
    avoidanceAlternative: "--break-line-sub",
    avoidanceMitigatesGap: "--break-line-indirect-risk",
    attackToolPrerequisite: "--break-line-cause-risk",
    attackToolCoUsed: "--break-line-build-tool",
    attackToolAlternative: "--break-line-sub",
    attackToolCapabilityUpgrade: "--break-line-direct-risk",
