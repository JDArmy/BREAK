...
function createGitRepo() {
  ...
  writeFile(root, "docs/zh-CN/01-getting-started.md", "快速上手\n");
  writeFile(root, "docs/en/01-getting-started.md", "Getting Started\n");
  writeFile(root, "docs/zh-CN/04-data-model.md", "数据模型\n");
  writeFile(root, "docs/en/04-data-model.md", "Data Model\n");
  writeFile(root, "docs/zh-CN/06-architecture.md", "架构\n");
  writeFile(root, "docs/en/06-architecture.md", "Architecture\n");
  writeFile(root, "docs/zh-CN/08-release-maintenance.md", "发布维护\n");
  writeFile(root, "docs/en/08-release-maintenance.md", "Release Maintenance\n");
...
describe("docs-freshness.mjs", () => {
  ...
  it("同时补齐使用手册、README 和 Skill 文档时通过", () => {
    ...
    writeFile(root, "docs/zh-CN/01-getting-started.md", "快速上手：更新界面说明\n");
    writeFile(root, "docs/en/01-getting-started.md", "Getting Started: update interface notes\n");
    writeFile(root, "docs/zh-CN/04-data-model.md", "数据模型：更新结构说明\n");
    writeFile(root, "docs/en/04-data-model.md", "Data Model: update structure notes\n");
    writeFile(root, "docs/zh-CN/06-architecture.md", "架构：更新数据流说明\n");
    writeFile(root, "docs/en/06-architecture.md", "Architecture: update data-flow notes\n");
    writeFile(root, "docs/zh-CN/08-release-maintenance.md", "发布维护：更新流程说明\n");
    writeFile(root, "docs/en/08-release-maintenance.md", "Release Maintenance: update workflow notes\n");
