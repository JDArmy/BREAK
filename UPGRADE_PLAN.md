...
- `relationCoverageAnalysis.ts`：已抽出节点 item builder、规避手段排序、洞察 section builder 和跨实体反查 helper；后续继续拆出 risk/avoidance/tool/actor coverage builder 与 special insight builder，并保持现有测试不回退。
