...
1. **内容与引用治理仍需闭环**：review 152 + timeout 150 + connection_error 66 条问题链接仍需按域名策略分批复核；高价值案例 primary source 覆盖率为 81.39%（201 个缺口），其中 criminal_verdict 类仍是最大短板。
...
已完成：审计工具链已建成（`case-source-quality.mjs`），可按类别统计高价值案例 primary 覆盖率；当前全量覆盖率 68.34%，高价值覆盖率 81.39%，并已将 `view.inews.qq.com` 归入 secondary 来源以减少 unknown 噪声。

未完成工作：
- 高价值 1,080 案例中 201 个缺 primary source。按类别分批补源：
  - `criminal_verdict`：72.07%（167 个缺口，最大短板），优先法院、检察院、公安、监管通报。
...
- 下一批继续处理审计队列中仍缺 primary 的司法/执法案例；当前 Top 50 为：`C0054`、`C0061`、`C0087`、`C0093`、`C0100`、`C0179`、`C0187`、`C0209`、`C0218`、`C0252`、`C0350`、`C0379`、`C0391`、`C0439`、`C0447`、`C0449`、`C0466`、`C0490`、`C0491`、`C0495`、`C0496`、`C0530`、`C0546`、`C0566`、`C0574`、`C0592`、`C0597`、`C0600`、`C0619`、`C0631`、`C0633`、`C0636`、`C0644`、`C0646`、`C0650`、`C0662`、`C0664`、`C0686`、`C0688`、`C0706`、`C0719`、`C0731`、`C0733`、`C0737`、`C0738`、`C0740`、`C0762`。
