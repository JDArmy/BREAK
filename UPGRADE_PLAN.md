...
- 最新进展：继续为 `C0781`、`C1678` 补充 GitHub 和国家网络安全通报中心官方来源；当前 `npm run audit:case-source-quality` 指标为 primary 覆盖 858、高价值 primary 覆盖 535、primary 覆盖率 47.75%、高价值 primary 覆盖率 49.58%。
