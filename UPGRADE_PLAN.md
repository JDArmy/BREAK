...
1. **内容与引用治理仍需闭环**：review 152 + timeout 150 + connection_error 66 条问题链接仍需按域名策略分批复核；高价值案例 primary source 覆盖率为 55.42%（481 个缺口），其中 criminal_verdict 类仍是最大短板。
...
已完成：审计工具链已建成（`case-source-quality.mjs`），可按类别统计高价值案例 primary 覆盖率；当前全量覆盖率 52.03%，高价值覆盖率 55.42%，并已将 `view.inews.qq.com` 归入 secondary 来源以减少 unknown 噪声。

未完成工作：
- 高价值 1,079 案例中 481 个缺 primary source。按类别分批补源：
  - `criminal_verdict`：42.40%（345 个缺口，最大短板），优先法院、检察院、公安、监管通报。
  - `administrative_enforcement`：48.45%（83 个缺口），优先各级市场监管局、网信办官网。
  - `news_report`：13.90%（347 个缺口），价值相对低，按需处理。
  - `security_incident`：79.76%，`academic_research`：89.21%，`vulnerability_advisory`：97.01% — 已较好。
- 下一批继续处理审计队列中仍缺 primary 的司法/执法案例；`C0027`、`C0034`、`C0054`、`C0061`、`C0087`、`C0100`、`C0112`、`C0130`、`C0132`、`C0133`、`C0136`、`C0138`、`C0146`、`C0147`、`C0150`、`C0161`、`C0179`、`C0184`、`C0187`、`C0188`、`C0191`、`C0204`、`C0211`、`C0217`、`C0218`、`C0232`、`C0240`、`C0250`、`C0261`、`C0273`、`C0277`、`C0287`、`C0292`、`C0306`、`C0315`、`C0330`、`C0340`、`C0344`、`C0350`、`C0353`、`C0376`、`C0377`、`C0381`、`C0384`、`C0391`、`C0396`、`C0398`、`C0401`、`C0408`、`C0450`、`C0451`、`C0457`、`C0458`、`C0461`、`C0462`、`C0571`、`C0579`、`C0581`、`C0589`、`C0591`、`C0592`、`C0593` 已复核但暂未找到高置信同案 primary、当前案情不匹配或来源支撑不足，不硬补。
