...
- Cases are lazily loaded (1781+ entries); the home page does not load them. They load when users visit `/knowledges/case/list`, use global search, or trigger a related-case reverse query
