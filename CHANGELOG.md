...
- 为 `C0382`、`C0453`、`C0576`、`C0577`、`C0578`、`C0580`、`C0657` 追加检察院、法院、市场监管、公安官网和官方政务号 primary 来源，并同步英文引用标题
- 按余姚警方官方通报将 `C0657` 抓获犯罪嫌疑人数从 37 名修正为 35 名，并同步英文摘要
- 将 `C0576`、`C0578` 对应法院官方澎湃号按精确 URL 纳入案例来源审计 primary 白名单，未放宽整站规则
- 复核 `C0381`、`C0384`、`C0391`、`C0396`、`C0398`、`C0450`、`C0451`、`C0457`、`C0458`、`C0461`、`C0462`、`C0579`、`C0581` 等候选时，未找到高置信同案 primary 或来源层级不足的不硬补
- 案例 primary 覆盖提升到 926，高价值 primary 覆盖提升到 591，primary 覆盖率提升到 51.53%，高价值 primary 覆盖率提升到 54.77%
- 更新升级计划中的 P0-2 案例来源覆盖统计和已复核队列

## 2.24.1

- 为 `C0251`、`C0257`、`C0291`、`C0588`、`C0590` 追加检察系统、网信办和市场监管官网等 primary 来源，并同步英文引用标题
- 将 `C0251` 的江苏检察在线同案报道按精确 URL 纳入案例来源审计 primary 白名单，依据为太仓市人民检察院官网宣传看点索引指向，未放宽整站规则
- 复核 `C0232`、`C0240`、`C0273`、`C0277`、`C0287`、`C0292`、`C0306`、`C0315`、`C0330`、`C0340`、`C0344`、`C0589`、`C0591`、`C0592`、`C0593` 等候选时，未找到高置信同案 primary 或案情支撑不足的不硬补
- 案例 primary 覆盖提升到 919，高价值 primary 覆盖提升到 584，primary 覆盖率提升到 51.14%，高价值 primary 覆盖率提升到 54.12%
