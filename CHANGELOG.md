...
- 新增：5个实体（第3批P1）
  - A0088 AI内容溯源：为AI生成内容添加可验证来源标识的安全控制手段
  - A0089 智能体行为沙箱：在隔离环境中运行AI智能体并约束其行为的安全控制手段
  - A0090 OAuth权限最小化：对OAuth授权流程权限进行细粒度控制的安全控制手段
  - TA0040 数据掮客：暗网和地下市场从事个人数据交易的中介角色
  - R0153 影子AI风险：员工未经授权使用第三方AI工具处理业务数据的风险
