...
> Generated from `src/validation/breakSchema.ts` for package version `2.35.1`.
...
|--------|-----------|--------------|------------|-----------------|
| Risk | `src/BREAK/risks` | `R0001.json` | `R0001 or R0001-001` | 366 total (250 main, 116 sub) |
| Avoidance | `src/BREAK/avoidances` | `A0001.json` | `A0001 or A0001-001` | 302 total (199 main, 103 sub) |
...
| Term | `src/BREAK/terms` | `T0001.json` | `T0001` | 579 total (515 main, 64 sub) |
