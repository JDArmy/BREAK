...
> Generated from `src/validation/breakSchema.ts` for package version `2.40.10`.
...
|--------|-----------|--------------|------------|-----------------|
| Risk | `src/BREAK/risks` | `R0001.json` | `R0001 or R0001-001` | 382 total (262 main, 120 sub) |
...
| Case | `src/BREAK/cases` | `C0001.json` | `C0001` | 1768 total (1768 main, 0 sub) |
